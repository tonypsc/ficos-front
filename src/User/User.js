                    ...
                    <div className="col p-4">
                        ...
                        <div className="row">
                            ...
                            <div className="" style={{width: "130px"}}>
                                <Link to="/user/add" className="btn btn-primary w-100"> <i className="fa fa-plus"></i> Agregar</Link>
                            </div>
                        </div>
                            ...
                            : 
                                    data 
                                        ?
                                            ...
                                            :
                                            <>
                                                <UserList data={data} handleDelete={handleDelete} page={page} search={search}/>
